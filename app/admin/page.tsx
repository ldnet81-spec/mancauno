...
export default async function AdminPage({ searchParams }: AdminPageProps) {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-5xl bg-white px-6 py-8 text-black">
        ...
        <label className="block">
          ...
          <div className="mt-2 flex gap-2">
            <input
              ...
              placeholder={
                section === "users"
                  ? "Email, nome, telefono o circolo"
                  : "Titolo, cittÃ , sport o luogo"
              }
      ...
      {section === "users" ? (
        <section>
          <h2 className="text-2xl font-semibold">Lista utenti</h2>
                ...
                >
                  <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-600">
                        Status: {event.status} -{" "}
                        {formatRemainingSpots(event.remaining_spots)} - Coda{" "}
